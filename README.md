...
When the page loads you are presented with a background image of a whiteboard, books and a globe.
...
When the user selects help, a window pops up with detailed illustrations of how to play the game. 

If the user selects the feedback button, a form pops up, where they can leave a message. 

When the user clicks start, a window pops up asking them to choose a difficulty level. 
The difference in levels are explained in the 'help' section. 
...
Testing Information can be found here [Testing.md](https://github.com/SirajRafique/Memory-Game/blob/master/testing.md){:target="_blank" rel="noopener"}
